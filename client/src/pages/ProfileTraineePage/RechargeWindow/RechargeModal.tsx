...
type props = {
    ...
    cardExpDate: string;
    setCardExpDate: React.Dispatch<React.SetStateAction<string>>;
    cardCSV: string;
    setCardCSV: React.Dispatch<React.SetStateAction<string>>;
};
            ...
            >
                ...
                >
                    <MaskInput
                        ...
                        onFocus={() => setCardFlipped(false)}
                        value={cardExpDate}
                        onValueChange={(e) => setCardExpDate(e.maskedValue)}
                    />
                    <MaskInput
                        /*
                        // @ts-ignore */
